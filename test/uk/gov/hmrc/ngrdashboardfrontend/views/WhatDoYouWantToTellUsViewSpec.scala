...
class WhatDoYouWantToTellUsViewSpec extends ViewBaseSpec {
  ...
  object Selectors {
    ...
    val mainContentSubheading1 = "#main-content > div > div > h2:nth-child(3)"
    val mainContentSubheading2 = "#main-content > div > div > h2:nth-child(6)"
    val mainContentLink1 = "#main-content > div > div > p:nth-child(4) > a"
    val mainContentP1 = "#main-content > div > div > p:nth-child(7)"
    val mainContentLink2 = "#main-content > div > div > p:nth-child(8) > a"
    val mainContentP2 = "#main-content > div > div > p:nth-child(10)"
    val mainContentLink3 = "#main-content > div > div > p:nth-child(11) > a"
    val mainContentP3 = "#main-content > div > div > p:nth-child(13)"
    val mainContentLink4 = "#main-content > div > div > p:nth-child(14) > a"
  }
